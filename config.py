...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002399768917"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1345506970 7390656935").split()):
        ADMINS.append(int(x))
except ValueError:
