...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002184924304"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002241255482"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1345506970 7480530355").split()):
        ADMINS.append(int(x))
except ValueError:
